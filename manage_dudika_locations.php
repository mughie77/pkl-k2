...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Lokasi & Informasi DUDIKA</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="core/export_handler.php?report_type=dudika_list" class="btn btn-success btn-sm">
                    ...
                    <tbody>
                        <?php foreach ($companies as $company): ?>
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($company['instructors'])): ?>
                                        <ul class="list-unstyled mb-0">
                                            <?php foreach ($company['instructors'] as $instructor): ?>
                                                <li><?php echo htmlspecialchars($instructor); ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    <?php else: ?>
                                        -
